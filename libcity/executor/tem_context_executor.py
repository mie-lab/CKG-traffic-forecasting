...
class TemporalContextExecutor(TrafficStateExecutor):
    ...
    def _build_train_loss(self):
        ...
        def func(batch, idx=None, batches_seen=None):
            if idx is not None:
                ...
                y_true = batch['y'][:, :, idx, :]  #YZflag
                batch_new = {'X': tx}  #YZflag
    ...
    def train(self, train_dataloader, eval_dataloader):
        ...
        for epoch_idx in range(self._epoch_num, self.epochs):
            ...
            self._writer.add_scalar('training loss', np.mean(losses), batches_seen)    # epoch_idx
